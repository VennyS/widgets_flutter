...
/// Map defining the default leading icons for each toast variant.
...
class ToastWidgetState extends State<ToastWidget> {
  ...
  /// Map of icons to use for the toast.
  ...
  void initState() {
    ...
    _icons = widget.icons ?? toastIcons; // Use provided icons or default icons
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: SvgPicture.asset("assets/svgs/close.svg"), // Close icon
          ),
        ],
      ),
    );
